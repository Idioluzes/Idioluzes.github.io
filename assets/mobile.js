...
(function () {
    ...
    <ul style="list-style:none;margin:0;padding:12px 0;flex:1;">
      ...
      <li>
        ...
        <ul id="m-dl-redes" style="display:none;list-style:none;padding:0;margin:0;">
          ...
          <li><a href="#" data-externo="https://www.instagram.com/governogoias" class="_drawer-sub" style="display:flex;align-items:center;gap:10px;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;"><svg width="17" height="17" viewBox="0 0 24 24" fill="#E1306C" style="flex-shrink:0;"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>Instagram</a></li>
          <li><a href="#" data-externo="https://t.me/diariodetorcedor" class="_drawer-sub" style="display:flex;align-items:center;gap:10px;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;"><svg width="17" height="17" viewBox="0 0 24 24" fill="#229ED9" style="flex-shrink:0;"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>Canal Telegram</a></li>
          <li><a href="#" data-externo="https://play.google.com/store/apps/details?id=com.google.android.googlequicksearchbox&hl=pt_BR" class="_drawer-sub" style="display:flex;align-items:center;gap:10px;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;"><svg width="17" height="17" viewBox="0 0 24 24" fill="#01875F" style="flex-shrink:0;"><path d="M8 5v14l11-7z"/></svg>Google Play</a></li>
          <li><a href="#" data-externo="https://apps.apple.com/br/app/google/id284815942" class="_drawer-sub" style="display:flex;align-items:center;gap:10px;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;"><svg width="17" height="17" viewBox="0 0 24 24" fill="#555" style="flex-shrink:0;"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>App Store</a></li>
      ...
      <li>
        <button data-drawer-toggle="m-dl-diaruim" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:14px 20px;color:#1C1C1E;font-family:sans-serif;font-size:.9rem;font-weight:600;background:none;border:none;border-bottom:1px solid #f0f0f0;cursor:pointer;">
          Dia Ruim?
          <svg data-arrow width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" style="flex-shrink:0;transition:transform .2s;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 18l6-6-6-6"/></svg>
        </button>
        <ul id="m-dl-diaruim" style="display:none;list-style:none;padding:0;margin:0;">
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Aconselhamentos</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Reflexões Diárias</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Plano de Leitura</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Mensagens de Afirmação</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Descanse em Paz</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Depressão</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f0f0f0;background:#F9F7F4;">Perda do Emprego</a></li>
        </ul>
      </li>

      <li>
        <button data-drawer-toggle="m-dl-envolva" style="width:100%;display:flex;align-items:center;justify-content:space-between;padding:14px 20px;color:#1C1C1E;font-family:sans-serif;font-size:.9rem;font-weight:600;background:none;border:none;border-bottom:1px solid #f0f0f0;cursor:pointer;">
          Se Envolva
          <svg data-arrow width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24" style="flex-shrink:0;transition:transform .2s;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 18l6-6-6-6"/></svg>
        </button>
        <ul id="m-dl-envolva" style="display:none;list-style:none;padding:0;margin:0;">
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Votações</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Fórum</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f5f5f5;background:#F9F7F4;">Listas de Distribuição</a></li>
          <li><a href="#" data-placeholder class="_drawer-sub" style="display:block;padding:11px 20px 11px 32px;color:#6B6B6B;font-family:sans-serif;font-size:.85rem;font-weight:600;text-decoration:none;border-bottom:1px solid #f0f0f0;background:#F9F7F4;">Enviar Material</a></li>
        </ul>
      </li>
  ...
  <!-- LINHAS DE BORDA DE CONTEÚDO — desktop only, posicionadas via JS -->
  <div id="ga-borda-l" style="position:fixed;top:0;bottom:0;width:1px;z-index:40;pointer-events:none;display:none;"></div>
  <div id="ga-borda-r" style="position:fixed;top:0;bottom:0;width:1px;z-index:40;pointer-events:none;display:none;"></div>

  <!-- BARRA SOCIAL FIXA — desktop only, posicionada via JS -->
  <div id="ga-social-bar" role="complementary" aria-label="Redes sociais" style="position:fixed;top:130px;z-index:49;display:none;flex-direction:column;gap:4px;">
    <a href="#" data-externo="https://whatsapp.com/channel/0029VbBSupFAjPXGrgFRxG0V" title="Canal WhatsApp" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:#25D366;border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s,width .15s;flex-shrink:0;text-decoration:none;">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="#fff"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/></svg>
    </a>
    <a href="#" data-externo="https://www.instagram.com/governogoias" title="Instagram" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:linear-gradient(135deg,#f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%);border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s;flex-shrink:0;text-decoration:none;">
    ...
    <a href="#" data-externo="https://t.me/diariodetorcedor" title="Canal Telegram" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:#229ED9;border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s;flex-shrink:0;text-decoration:none;">
    ...
    <a href="#" data-externo="https://play.google.com/store/apps/details?id=com.google.android.googlequicksearchbox&hl=pt_BR" title="Google Play" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:#01875F;border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s;flex-shrink:0;text-decoration:none;">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="#fff"><path d="M8 5v14l11-7z"/></svg>
    </a>
    <a href="#" data-externo="https://apps.apple.com/br/app/google/id284815942" title="App Store" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:#555;border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s;flex-shrink:0;text-decoration:none;">
    ...
    <a href="#" data-externo="https://www.youtube.com/c/VlogdoCair%C3%A3oOficial" title="Canal YouTube" style="display:flex;align-items:center;justify-content:center;width:38px;height:38px;background:#FF0000;border-radius:6px 0 0 6px;opacity:.85;transition:opacity .15s;flex-shrink:0;text-decoration:none;">
  ...
  mobileStyle.textContent = [
    ...
    '}',
    // ── BARRA SOCIAL + LINHAS DE CONTEÚDO — desktop only ───────────
    // Cores das linhas de borda de conteúdo (posição definida via JS)
    '#ga-borda-l,#ga-borda-r{background:rgba(0,0,0,.07);}',
    '.dark #ga-borda-l,.dark #ga-borda-r{background:rgba(255,255,255,.07);}',
    // Ícones sociais: cantos totalmente arredondados (flutuam no meio da margem)
    '#ga-social-bar a{border-radius:8px!important;}',
    '#ga-social-bar a:hover{opacity:1!important;}',
  ...
  // ── LINHAS DE CONTEÚDO + POSIÇÃO DA BARRA SOCIAL ─────────────────
  // Usa getBoundingClientRect() no container max-w-6xl do header
  // para posicionar as linhas decorativas e a barra social exatamente
  // no limite do conteúdo (funciona em qualquer largura de viewport).

  function _posicionarSocialBar() {
    var bar   = document.getElementById('ga-social-bar');
    var lineL = document.getElementById('ga-borda-l');
    var lineR = document.getElementById('ga-borda-r');
    var mob   = window.innerWidth < 768;

    // Mobile: oculta tudo
    if (bar)   bar.style.display   = mob ? 'none' : 'flex';
    if (lineL) lineL.style.display = mob ? 'none' : 'block';
    if (lineR) lineR.style.display = mob ? 'none' : 'block';
    if (mob) return;

    // Mede o container centralizado do header
    var cnt = document.querySelector('header .max-w-6xl') ||
...
(function () {
  var allIds = ['biblia', 'redes', 'diaruim', 'envolva', 'cosmo', 'flags'];
  var timers = {};
