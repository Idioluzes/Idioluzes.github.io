...
(function () {
  ...
  <div id="ga-social-bar" role="complementary" aria-label="Redes sociais" style="position:fixed;top:88px;z-index:49;display:none;flex-direction:column;gap:3px;">
  ...
  function _posicionarSocialBar() {
    ...
    if (bar)   bar.style.left   = r.right + 'px';
  }
