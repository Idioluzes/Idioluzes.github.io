...
(function () {
  ...
  <!-- BARRA SOCIAL FIXA — desktop only (hidden on mobile via CSS) -->
  <div id="ga-social-bar" role="complementary" aria-label="Redes sociais" style="position:fixed;right:0;top:88px;z-index:49;display:none;flex-direction:column;gap:3px;">
  ...
  mobileStyle.textContent = [
    ...
    '}',
    // ── BARRA SOCIAL FIXA — desktop only ───────────────────────────
    // Mobile: oculta; Desktop: exibe como flex-column
    '@media(min-width:768px){#ga-social-bar{display:flex!important;}}',
